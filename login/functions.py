...
# REMOVE THIS!!!
def insert_users():
    user_list = [[18, "bennyl23@yahoo.com", "Bradiacs", "doughnuts", 1, 1, "Ben L", "Ben", "Ben", 0],
                [32, "tmdickson@comcast.net", "TMD24", "goldfever", 0, 1, "T Dix", "E", "Sap", 0],
                [29, "ronendo@comcast.net", "Exconendo", "exconendo", 1, 1, "RE", "E", "RE", 0],
